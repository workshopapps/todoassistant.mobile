...
const ModalPop = ({ modalMsg, modalNeg, modalPos, modalOption, setIsModal }) => {
  return (
      ...
      <View style={style.modalBody}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'flex-end' }}>
          <TouchableOpacity
            ...
            style={[style.actionButton, { marginHorizontal: 20 }]}>
            <Text>{modalNeg}</Text>
          </TouchableOpacity>

          <TouchableOpacity
            onPress={() => setIsModal(false)}
            style={[style.actionButton, { backgroundColor: '#DB0004' }]}>
