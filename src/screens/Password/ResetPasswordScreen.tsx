...
const ResetpasswordScreen = () => {
  ...
  return (
    <View className="p-5 flex-1 bg-white w-screen">
      ...
      <Text className="text-black mt-3 font-bold text-center text-[24px] leading-[28.8px]">Reset Password</Text>
      <View className="items-center">
        <Text className="text-black mt-3 text-center text-[18px] leading-[26px]">Your password should be atleast 9 characters of lower case and upper case</Text>
      </View>
